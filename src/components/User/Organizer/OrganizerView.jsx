...
function OrganizerView() {
  ...
  return (
    <div className="w-full">
      <div className="grid px-10  gap-4 my-5">
  ...
  >
                ...
                <div className="flex items-center gap-4 ">
                  <div className="flex flex-col ">
                    <DatePicker
                      ...
                      className="w-auto py-2 border text-black border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500"
                    />
                  </div>
                </div>
              </div>
    ...
    <CardFooter className="mt-12 p-0">
      ...
      <div>
        ...
        <div className="mx-5 sm:mx-10 px-5 sm:px-10 my-5">
  <div className="flex flex-col sm:flex-row justify-between">
    <h1 className="text-2xl sm:text-3xl text-black font-medium mx-2 sm:mx-5 mb-2 sm:mb-0">
      Rating & Reviews
    </h1>
    {authorized && (
      <div className="flex justify-end sm:text-lg">
        <button
          className="shadow-lg p-4 shadow-gray-400 cursor-pointer rounded-lg sm:w-auto sm:px-8"
  ...
  <div className="px-2 sm:px-10">
    {showReview.length > 0 ? (
      ...
      <p className="text-lg text-center">No Ratings Yet</p>
    )}
  </div>
</div>
