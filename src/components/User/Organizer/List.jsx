...
function List({ title, description, img, id, organizer, review, budget,rating }) {
      ...
      >
        ...
        <div className={`p-5 h-64 mb-5`} style={{ minHeight: "7rem" }}>
          ...
          <div className="flex flex-wrap justify-between mt-5">
            <div className="flex">{stars}<span className="text-gray-600 text-sm font-arimo">({review})</span></div>
