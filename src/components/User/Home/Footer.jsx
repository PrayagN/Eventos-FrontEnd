          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-2">
            <div className="mb-5">
              ...
              <p className="text-gray-500">
                ...
                india <br />
                <br />
                <strong>Phone:</strong>+91 9745001210 <br />
            ...
            <div className="mb-5">
              ...
              <ul className="text-gray-500">
                <li className="pb-4 hover:text-blue-600">
                  <Link to={"/"} >
                    Home
                  </Link>
                </li>
            ...
            <div className="mb-5">
              ...
              <form>
                <input
                  className="text-gray-500 w-2/3 p-2 focus:border-blue-600"
                  type="text"
                />
                <button className="p-2 2-1/3 bg-blue-100 text-black hover:bg-gray-400">
                  Subscribe
                </button>
              </form>
            </div>
