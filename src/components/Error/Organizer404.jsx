...
function Organizer404() {
    ...
    return (
      <main className="min-h-screen max-w-screen-2xl mx-auto w-full flex flex-col justify-center items-center bg-slate-400">
        ...
        <button className="mt-5">
          <a className="relative inline-block text-sm font-medium text-white group active:text-orange-500 focus:outline-none focus:ring">
            ...
            <span className="relative block px-8 py-3 bg-[#1A2238] border border-current" onClick={()=>navigate('/tutor')}>
          Go Home
            </span>
          </a>
        </button>
