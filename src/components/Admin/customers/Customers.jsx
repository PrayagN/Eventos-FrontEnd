  ...
  <div className="rounded-full w-12  m-2">
    ...
    />
      ...
      <div className="mt-32 mx-8">
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg shadow-gray-600 h-auto  ">
          <div class="flex items-center justify-between pb-4 bg-white ">
            <div>
              ...
              >
                <ul
                  class="py-1 text-sm  dark:text-gray-200"
            ...
            <div class="relative">
              ...
              <input
                ...
                class="block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500  dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <td class="w-4 p-4">
                  <div class="flex items-center">
                    <input
                      id="checkbox-table-search-2"
                      type="checkbox"
                      class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600  dark:border-gray-600"
                    />
                    <label for="checkbox-table-search-2" class="sr-only">
                      checkbox
                    </label>
