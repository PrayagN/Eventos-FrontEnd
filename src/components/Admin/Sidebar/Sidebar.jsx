...
function Sidebar() {
  ...
  return (
    <div className="flex flex-col  h-auto md:flex-row shadow-lg shadow-gray-600 bg-white ">
          ...
          {menu?.map((menuItem, index) => (
            <div key={index}>
              ...
              >
                ...
                {menuItem.submenu && (
                  <AiOutlineCaretDown  className={`${submenu ?'rotate-360':'rotate-180'} ml-32` } onClick={() => setSubmenu(!submenu)} />
                )}
              </Link>
                  ...
                  {menuItem.submenuItems.map((submenuItem, subIndex) => (
                    <Link
                      ...
                      className={`${
                        ...
                        active === submenu.name ? "bg-slate-100 rounded-lg translate-x-2" : ""
                      }`}                    >
