...
function OrganizerView() {
  ...
  <div className="w-full md:w-2/6 flex-1">
  ...
  <div className="w-auto md:w-4/6 flex-1">
    <Card className="p-2">
      ...
      <br />
      <div className="flex flex-col md:flex-row md:items-center gap-4 lg:gap-20 pr-9 px-5">
        <label>
          Mobile
          <Input
            variant="static"
        ...
        <label>
          ...
          <Input
            variant="static"
            className="w-auto md:w-auto lg:w-auto"
            style={{ fontWeight: "bold" }}
            value={joinDate}
          />
        </label>
      ...
      <br />
      <div className="flex flex-col md:flex-row md:items-center gap-4 lg:gap-40 px-5">
        <label>
          District
          <Input
            variant="static"
      ...
      <br />
      <div className="flex flex-col md:flex-row md:items-center gap-4 lg:gap-28 px-5">
        <label>
          Conducted
          <Input
            variant="static"
      ...
      <br />
      <div className="flex flex-col md:flex-row md:items-center w-full px-5 pb-5">
